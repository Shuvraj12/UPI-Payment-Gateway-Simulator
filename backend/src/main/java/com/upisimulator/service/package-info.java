 ...
 * {@link com.upisimulator.service.WalletService}. Phase 5 adds
 * {@link com.upisimulator.service.BankAccountService} and
 * {@link com.upisimulator.service.SimulatedOutcomeSource} (the injectable
 * randomness behind simulated verification, kept separate so it's mockable).
 * Controllers depend on the interface, never the implementation, so
 * services stay swappable and mockable in tests.
 */
